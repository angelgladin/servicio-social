...
En caso de que existiera una m\'aquina que acepte $L$ debe ser aquella que 
pueda recordar cu\'antas $a$'s hay al inicio de la cadena para verificar el 
mismo n\'umero de $b$'s al final. 
Los aut\'omatas finitos pueden recordar patrones sencillos pero no un n\'umero 
para hacer coincidir subcadenas, de la misma forma tampoco se pueden comparar 
dos n\'umeros y decidir si son iguales o no.\\

\noindent Veamos dos ejemplos de lenguajes no regulares al tratar de dar una 
expresi\'on regular que los genere:
