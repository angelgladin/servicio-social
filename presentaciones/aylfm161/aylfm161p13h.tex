...
{Maestría en Ciencia e Ingeniería de la Computación UNAM\\
  Tema 13:  Máquinas de Turing y computabilidad}
...
%\subsection{Máquina Estándar}
\begin{frame}
  \titulos{Máquina Estándar de Turing}{Máquinas de Turing}
  \bi
...
\pause
  ...
  \bi
  \item El estado actual de la unidad de control (cabeza).\espc
    \item El contenido de la cinta.\espc
      \item La posición de la unidad de control.\espc
        \item Configuración inicial: $\alert{q_0}w$
  \ei
\end{frame}
...
\espc \\ \pause
$\vdash^\star$ se define de la manera usual.
\end{frame}
...
\begin{frame}
  ...
  entrada con las cuales la máquina se detiene en un estado final.
\beqs
L(M)=\{w\in\sest\;|\;q_0w\vdash^\star w_1q_fw_2\;\;q_f\in F\}
\eeqs\pause
Observaciones:
\bi
...
\item Formalmente tenemos
      ...
      \beqs L(M)=\{w\in\S^\star-\{[,]\}\;|\;q_0[w]\vdash^\star
      w_1q_fw_2\;\;q_f\in F\}\eeqs
