...
\newcommand{\teo}[1]{\begin{theorem2} #1 \end{theorem2}}
\newtheorem{proposition}{Proposici\'on}
\newcommand{\prop}[1]{\begin{proposition} #1 \end{proposition}}
\newtheorem{definition2}{Definici\'on}
\newcommand{\defin}[1]{\begin{definition2} #1 \end{definition2}}
%\newtheorem{corollary}{Corolario}
\newcommand{\cor}[1]{\begin{corollary} #1 \end{corollary}}
\newtheorem{lemma2}{Lema}
\newcommand{\lema}[1]{\begin{lemma2} #1 \end{lemma2}}
