...
\title[AyLF MCIC 2016-1]{Autómatas y Lenguajes Formales 2019-I}
\subtitle
          ...
          \item Tal vez $U$ no existía.\espc
            \item ?`Cómo probar la no existencia de $U$?\espc
              \item Era necesario definir el concepto de algoritmo de
                ...
                los mismos.\espc
                \item Tal formalismo deberia ser preciso
...
\begin{frame}
 ...
 \item El símbolo $s_i$ se codifica como $1^i$.
   \item Las cadenas de $\G^\star$ se codifican separando cada símbolo
     con $0$.
  \item Por ejemplo, si $\G=\{\blanks,a,b\}$ entonces codificamos
    $\blanks:=1,\;a:=11,\;b:=111$.
    \item La palabra $bab\blanks aa$ se codifica como:
      \beqs
...
\begin{frame}
  ...
  \eeqs
  \beqs
  \de(q_3,a)=(q_1,c,\der)\;\;\;\;\;\de(q_1,b)=(q_3,\blanks,-) 
  \eeqs
