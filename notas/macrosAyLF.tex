...
\newcommand{\nat}{\mathsf{nat}}
\newcommand{\lista}{\mathop{{\sf list}}}
...
\newcommand{\bol}{\mathop{\mathtt{bool}}}
\newcommand{\lete}[2]{\mathsf{let}\;#1\;\mathsf{in}\;#2\;\mathsf{end}}
...
%\newcommand{\dfun}[4]{\mathsf{fun}\;#1\,(#2):#3\;\Imp\;#4}
\newcommand{\recp}[5]{\mathsf{rec}\;#1\;\{0\Imp #2\;|\;s(#3)\;\mathsf{with}\;#4 
\Imp #5\}}
