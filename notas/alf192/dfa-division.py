class DFA(object):
    ...
    def __fill_transition_table(self):
        # Representation of the automata in a matrix.
        automata = [[0, 0] for _ in range(k)]
        # Computing each transition for every state.
...
if __name__ == "__main__":
    # Reading the input. Each number must be terminated by a new line.
    n = int(input())
    k = int(input())
